...
|Live Search| **Expected**<br>While entering a search string a preliminary list of live results should be displayed<br><br>**Constraints**<br><br><br>**Main Actor**<br>User                                     |DONE|
|Display Root Element| **Expected**<br>When no search query is entered, the root element of the catalogue should be displayed<br><br>**Constraints**<br><br><br>**Main Actor**<br>System                                    |TODO|
...
|Tooltip| **Expected**<br>When hovering an element of the hierrchical structure a tooltip containing the description of the element should appear<br><br>**Constraints**<br><br><br>**Main Actor**<br>System                                     |TODO|---------------|:---------|
...
| Title                              | Description                      | Status |
|:-----------------------------------|:---------------------------------|:---------|
|Analytics| **Expected**<br>After a search query feedback about clicked elements should be sent to the system. <br><br>**Constraints**<br><br>Only the first clicked element should be considered<br>**Main Actor**<br>System                                                                                       |TODO|---------------|:---------|
